...
class RAGTool:
    def __init__(self, docs_dir: str):
        ...
        self._query_engine = self._index.as_query_engine(vector_store_query_mode=VectorStoreQueryMode.DEFAULT, similarity_top_k=10, response_mode="compact_accumulate")
